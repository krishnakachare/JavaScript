...
// var a = ['sanchita', 'dhole', 'komal', 'sanchita']
// a.forEach(loop)

// function loop(value, index, welcome) {

//     console.log(index + welcome + ":" + value + a)
// }
...
// var two = numbers.map(function(el, index) {
//     return el * 2
...
// var tr = number.map(function(value) {
//     sum = value + 2
//     return sum
// })
...
// var num = [20, 10, 5, 2, 55, 22]
// var numgreater = num.filter(function(value, index, array) {
//     return value > 10
...
var x = [3, 5, 6, 7, 8]
var xc = x.reduce((acc, currentvalue) => {
    return acc + currentvalue
